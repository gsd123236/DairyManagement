...
import com.dairy.Services.FarmerBalanceSheetService;
...
@RestController
@RequestMapping ("/api/farmerBalanceSheet")
public class FarmerBalanceSheetController {
    @Autowired
private FarmerBalanceSheetService service;
